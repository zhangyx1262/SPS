...
public class SimpleSearchDTO {
    ...
    private static String PARAM_SEARCH_PREFIX = "search_";
        private String search_wh_no;     //入库编号

        public void setSearch_wh_no(String wh_no){
            this.search_wh_no = wh_no;
        }
        public String getSearch_wh_no(){
            return this.search_wh_no;
        }
        ...
        private String search_whstate;     //入库状态

        public void setSearch_whstate(String whstate){
            this.search_whstate = whstate;
        }
        public String getSearch_whstate(){
            return this.search_whstate;
        }

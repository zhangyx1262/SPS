package com.yonyou.rejected.dto;
...
public class SimpleSearchDTO {
    ...
    private static String PARAM_SEARCH_PREFIX = "search_";
        private String search_rj_no;     //退货单编号

        public void setSearch_rj_no(String rj_no){
            this.search_rj_no = rj_no;
        }
        public String getSearch_rj_no(){
            return this.search_rj_no;
        }

        private String search_qc_no;     //质检单编号

        public void setSearch_qc_no(String qc_no){
            this.search_qc_no = qc_no;
        }
        public String getSearch_qc_no(){
            return this.search_qc_no;
        }

        private String search_rjstate;     //退货状态

        public void setSearch_rjstate(String rjstate){
            this.search_rjstate = rjstate;
        }
        public String getSearch_rjstate(){
            return this.search_rjstate;
        }

...
public class SimpleSearchDTO {
    ...
    private static String PARAM_SEARCH_PREFIX = "search_";
        ...
        private String search_pr_no;     //申请编号
        ...
        private String search_rstute;     //审核状态

        public void setSearch_rstute(String rstute){
            this.search_rstute = rstute;
        }
        public String getSearch_rstute(){
            return this.search_rstute;
        }

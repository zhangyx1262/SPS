...
public class SimpleSearchDTO {
    ...
    private static String PARAM_SEARCH_PREFIX = "search_";
        private String search_qc_no;     //质检编号
        ...
        private String search_po_no;     //订单编号

        public void setSearch_po_no(String po_no){
            this.search_po_no = po_no;
        }
        public String getSearch_po_no(){
            return this.search_po_no;
        }

        private String search_qc_state;     //质检状态

        public void setSearch_qc_state(String qc_state){
            this.search_qc_state = qc_state;
        }
        public String getSearch_qc_state(){
            return this.search_qc_state;
        }

...
Error: Invalid GBK character "\xE6"
        on line 1 of ../node_modules/tinper-bee-core/scss/index.scss
        from line 1 of TabsDemo.scss

1: // 核心文件
2: 
3: // 导入参数/函数类文件,minxin有依赖关系，此部分请按照顺序加载
4: @import "./minxin-colors";
5: @import "./minxin-themeColors";
6: @import "./minxin-variables";

Backtrace:
../node_modules/tinper-bee-core/scss/index.scss:1
TabsDemo.scss:1
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/util.rb:1300:in `rescue in block in find_encoding_error'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/util.rb:1297:in `block in find_encoding_error'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/util.rb:1296:in `each'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/util.rb:1296:in `each_with_index'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/util.rb:1296:in `find_encoding_error'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/util.rb:905:in `check_sass_encoding'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/engine.rb:436:in `check_encoding!'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/engine.rb:392:in `_to_tree'
...
body:before {
  ...
  content: "Error: Invalid GBK character \"\xE6\"\A         on line 1 of ../node_modules/tinper-bee-core/scss/index.scss\A         from line 1 of TabsDemo.scss\A \A 1: // 核心文件\A 2: \A 3: // 导入参数/函数类文件,minxin有依赖关系，此部分请按照顺序加载\A 4: @import \"./minxin-colors\";\A 5: @import \"./minxin-themeColors\";\A 6: @import \"./minxin-variables\";"; }

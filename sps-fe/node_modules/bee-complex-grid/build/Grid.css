...
.u-dropdown {
  ...
  .u-dropdown-menu {
    ...
    background-color: #fff;
    border-radius: 3px;
    box-shadow: 0 1px 5px rgb(165, 173, 186);
    background-clip: padding-box; }
    .u-dropdown-menu > li {
      margin: 0;
      padding: 0; }
...
.u-menu-submenu-inline > .u-menu-submenu-title:hover .u-menu-submenu-arrow:before {
  ...
  background: linear-gradient(to right, #505F79, #505F79); }
...
.u-menu-horizontal > .u-menu-submenu-selected {
  border-bottom: 2px solid rgb(245, 60, 50);
  color: rgb(245, 60, 50); }
...
.u-menu-inline .u-menu-item:after {
  ...
  top: 0;
  bottom: 0;
  border-right: 3px solid rgb(245, 60, 50);
...
.u-radio-group .u-radio-button {
  ...
  .u-radio-group .u-radio-button.disabled {
    ...
    cursor: not-allowed;
    color: #909090; }
    .u-radio-group .u-radio-button.disabled span, .u-radio-group .u-radio-button.disabled label, .u-radio-group .u-radio-button.disabled input[type='radio'] {
      cursor: not-allowed; }
    .u-radio-group .u-radio-button.disabled:hover {
      ...
      box-shadow: none;
      cursor: not-allowed; }
  .u-radio-group .u-radio-button:hover, .u-radio-group .u-radio-button.is-checked {
    background: rgb(235, 236, 240); }
  .u-radio-group .u-radio-button:focus, .u-radio-group .u-radio-button.focus, .u-radio-group .u-radio-button:active, .u-radio-group .u-radio-button.active, .u-radio-group .u-radio-button.is-checked {
    border-color: rgb(245, 60, 50);
...
.u-radio {
  ...
  .u-radio.is-checked .u-radio-label:before {
    -moz-box-shadow: inset 0 0 0 10px rgb(255,255,255);
    -webkit-box-shadow: inset 0 0 0 10px rgb(255,255,255);
  ...
  .u-radio .u-radio-label {
    ...
    .u-radio .u-radio-label:before {
      ...
      border-radius: 50%;
      border: 2px solid rgb(165, 173, 186);
      background-color: #fff;
      content: '';
      font-family: 'uf';
      display: inline-block;
...
.u-grid th.u-table-expand-icon-th {
  width: 43px; }

.u-grid th .drop-menu .uf:not(.custom-icon) {
  font-size: 12px;
  visibility: hidden;
  color: #505F79;
  font-weight: bold;
...
.u-grid th .drop-menu {
  display: inline-block; }
  .u-grid th .drop-menu i.uf {
    padding-left: 4px;
    -ms-width: 12px;
    -ms-display: inline-block; }
  .u-grid th .drop-menu .drop-menu-title {
    text-overflow: ellipsis;
    white-space: nowrap;
    display: inline-block;
    vertical-align: middle;
...
.u-grid th .title-con.drop-menu {
  max-width: 100% !important; }

.u-grid th .cansort.drop-menu {
  max-width: calc(100% - 32px) !important; }

.u-grid th:last-child.column-number-right {
  padding-right: 34px; }

.u-grid th:last-child .cansort.drop-menu {
  width: calc(100% - 55px) !important; }

.u-grid th .bee-table-column-sorter {
  margin-left: 0px; }
  .u-grid th .bee-table-column-sorter i {
    padding: 0px; }

.u-grid th .bee-table-column-sorter > .bee-table-column-sorter-up {
  width: auto; }

.u-grid th:hover .drop-menu .uf {
  visibility: visible; }

.u-grid th ::last-child {
  overflow: hidden; }

.u-grid .u-table-fixed-left th:last-child .cansort.drop-menu {
  width: calc(100% - 32px) !important; }

.u-grid .u-pagination {
  overflow: hidden;
  margin-bottom: 8px; }
  .u-grid .u-pagination .u-pagination-list {
    margin-left: 0px; }
  .u-grid .u-pagination .data_per_select .u-select {
    width: 60px; }
  .u-grid .u-pagination.center {
    display: flex;
    justify-content: center; }
  .u-grid .u-pagination.right {
    display: flex;
...
.grid-toolbar {
  ...
  .grid-toolbar .u-button {
    margin-left: 8px; }
  .grid-toolbar .dropdown-btn {
    display: inline-block; }
  .grid-toolbar .toolbar-btn-icon.u-button {
    width: 26px;
    min-width: 0px;
    height: 26px;
    line-height: 26px;
    padding: 0px; }
    .grid-toolbar .toolbar-btn-icon.u-button .uf {
      padding: 0px; }
  .grid-toolbar .u-button:not(.u-button-icon) i.uf {
    vertical-align: middle;
    font-size: 14px; }
...
#filter_column_popover .u-table-filter-column-pop-cont-item .drop-menu .uf {
  display: none; }

#filter_column_popover.u-popover {
  z-index: 1701; }
